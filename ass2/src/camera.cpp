...
camera_t make_freeroam_camera(glm::vec3 pos, glm::vec3 target) {
    ...
    return { camera_t::FREE_ROAM, pos, yaw, pitch };
}

camera_t make_player_camera(glm::vec3 pos, glm::vec3 target) {
    glm::vec3 front = glm::normalize(target - pos);
    ...
    return { camera_t::PLAYER, pos, yaw, pitch };
}
